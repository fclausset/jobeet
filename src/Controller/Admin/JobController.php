...
class JobController extends AbstractController
{
     ...
     * Delete job.
     *
     * @Route("/admin/job/{id}/activate", name="admin.job.activate", methods="PUT", requirements={"id" = "\d+"})
     *
     * @param Request $request
     * @param EntityManagerInterface $em
     * @param Job $job
     ...
     * @return Response
     */
    public function activate(Request $request, EntityManagerInterface $em, Job $job) : Response
    {
        if ($this->isCsrfTokenValid('activate' . $job->getId(), $request->request->get('_token'))) {
